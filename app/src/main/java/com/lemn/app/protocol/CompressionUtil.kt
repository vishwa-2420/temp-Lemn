...
object CompressionUtil {
    private const val COMPRESSION_THRESHOLD = com.lemn.app.util.AppConstants.Protocol.COMPRESSION_THRESHOLD_BYTES  // bytes - same as iOS
