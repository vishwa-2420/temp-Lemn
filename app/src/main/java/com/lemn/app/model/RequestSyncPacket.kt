...
import com.lemn.app.sync.SyncDefaults

/**
 * REQUEST_SYNC payload using GCS (Golomb-Coded Set) parameters.
 * TLV (type, length16, value), types:
 *  - 0x01: P (uint8) â€” Golomb-Rice parameter
 *  - 0x02: M (uint32, big-endian) â€” hash range (N * 2^P)
 *  - 0x03: data (opaque) â€” GR bitstream bytes
 */
