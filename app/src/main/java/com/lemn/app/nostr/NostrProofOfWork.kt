    ...
    suspend fun mineEvent(
        ...
        while (iterations < maxIterations) {
            ...
            if (actualDifficulty >= targetDifficulty) {
                ...
                Log.i(TAG, "âœ… PoW mining successful! Difficulty: $actualDifficulty, iterations: $iterations, time: ${timeElapsed}ms")
        ...
        val timeElapsed = System.currentTimeMillis() - startTime
        Log.w(TAG, "âŒ PoW mining failed after $maxIterations iterations (${timeElapsed}ms)")
