...
import com.lemn.app.nostr.GeohashMessageHandler
import com.lemn.app.nostr.GeohashRepository
import com.lemn.app.nostr.NostrDirectMessageHandler
import com.lemn.app.nostr.NostrIdentityBridge
import com.lemn.app.nostr.NostrProtocol
import com.lemn.app.nostr.NostrRelayManager
import com.lemn.app.nostr.NostrSubscriptionManager
import com.lemn.app.nostr.PoWPreferenceManager
import com.lemn.app.nostr.GeohashAliasRegistry
import com.lemn.app.nostr.GeohashConversationRegistry
...
class GeohashViewModel(
    ...
    private var locationChannelManager: com.lemn.app.geohash.LocationChannelManager? = null
    ...
    fun initialize() {
        ...
        try {
            locationChannelManager = com.lemn.app.geohash.LocationChannelManager.getInstance(getApplication())
            ...
            state.setSelectedLocationChannel(com.lemn.app.geohash.ChannelID.Mesh)
    ...
    fun sendGeohashMessage(content: String, channel: com.lemn.app.geohash.GeohashChannel, myPeerID: String, nickname: String?) {
        viewModelScope.launch {
            try {
                ...
                val localMsg = com.lemn.app.model.BitchatMessage(
                    id = tempId,
                ...
                if (startedMining) {
                    com.lemn.app.ui.PoWMiningTracker.startMiningMessage(tempId)
                }
                try {
                    ...
                    if (startedMining) {
                        com.lemn.app.ui.PoWMiningTracker.stopMiningMessage(tempId)
                    }
                }
            } catch (e: Exception) {
    ...
    fun startGeohashDM(pubkeyHex: String, onStartPrivateChat: (String) -> Unit) {
        ...
        val gh = (current as? com.lemn.app.geohash.ChannelID.Location)?.channel?.geohash
        if (!gh.isNullOrEmpty()) {
    ...
    fun blockUserInGeohash(targetNickname: String) {
        ...
        if (pubkey != null) {
            ...
            val sysMsg = com.lemn.app.model.BitchatMessage(
                sender = "system",
    ...
    private fun switchLocationChannel(channel: com.lemn.app.geohash.ChannelID?) {
        ...
        when (channel) {
            is com.lemn.app.geohash.ChannelID.Mesh -> {
            ...
            is com.lemn.app.geohash.ChannelID.Location -> {
