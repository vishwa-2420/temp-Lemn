...
import com.lemn.app.favorites.FavoritesPersistenceService
import kotlinx.coroutines.flow.StateFlow
import kotlinx.coroutines.flow.MutableStateFlow
import kotlinx.coroutines.flow.asStateFlow
import com.lemn.app.mesh.BluetoothMeshDelegate
import com.lemn.app.mesh.BluetoothMeshService
import com.lemn.app.service.MeshServiceHolder
import com.lemn.app.model.BitchatMessage
import com.lemn.app.model.BitchatMessageType
import kotlinx.coroutines.flow.update
import com.lemn.app.nostr.NostrIdentityBridge
import com.lemn.app.protocol.BitchatPacket


import kotlinx.coroutines.launch
import com.lemn.app.util.NotificationIntervalManager
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch
import java.util.Date
import kotlin.random.Random
import com.lemn.app.services.VerificationService
import com.lemn.app.identity.SecureIdentityStateManager
import com.lemn.app.noise.NoiseSession
import com.lemn.app.nostr.GeohashAliasRegistry
import com.lemn.app.util.dataFromHexString
import com.lemn.app.util.hexEncodedString
...
class ChatViewModel(
    ...
    val selectedLocationChannel: StateFlow<com.lemn.app.geohash.ChannelID?> = state.selectedLocationChannel
    ...
    init {
        ...
        viewModelScope.launch {
            try { com.lemn.app.services.AppStateStore.peers.collect { peers ->
                state.setConnectedPeers(peers)
                state.setIsConnected(peers.isNotEmpty())
            } } catch (_: Exception) { }
        }
        viewModelScope.launch {
            try { com.lemn.app.services.AppStateStore.publicMessages.collect { msgs ->
                // Source of truth is AppStateStore; replace to avoid duplicate keys in LazyColumn
                state.setMessages(msgs)
            } } catch (_: Exception) { }
        }
        viewModelScope.launch {
            try { com.lemn.app.services.AppStateStore.privateMessages.collect { byPeer ->
                ...
                try {
                    val seen = com.lemn.app.services.SeenMessageStore.getInstance(getApplication())
        ...
        viewModelScope.launch {
            try { com.lemn.app.services.AppStateStore.channelMessages.collect { byChannel ->
                // Replace with store snapshot
        ...
        viewModelScope.launch {
            com.lemn.app.mesh.TransferProgressManager.events.collect { evt ->
    ...
    private fun loadAndInitialize() {
        ...
        viewModelScope.launch {
            com.lemn.app.ui.debug.DebugSettingsManager.getInstance().debugMessages.collect { msgs ->
                if (com.lemn.app.ui.debug.DebugSettingsManager.getInstance().verboseLoggingEnabled.value) {
                    ...
                    if (selectedLocation is com.lemn.app.geohash.ChannelID.Mesh) {
        ...
        com.lemn.app.favorites.FavoritesPersistenceService.initialize(getApplication())
        ...
        try {
            val nostrTransport = com.lemn.app.nostr.NostrTransport.getInstance(getApplication())
    ...
    private fun ensureGeohashDMSubscriptionIfNeeded(convKey: String) {
        try {
            ...
            val repo = repoField.get(geohashViewModel) as com.lemn.app.nostr.GeohashRepository
            ...
            if (!gh.isNullOrEmpty()) {
                ...
                val subMgr = subMgrField.get(geohashViewModel) as com.lemn.app.nostr.NostrSubscriptionManager
                val identity = com.lemn.app.nostr.NostrIdentityBridge.deriveIdentity(gh, getApplication())
                val subId = "geo-dm-$gh"
                ...
                if (currentId != subId) {
                    ...
                    subMgr.subscribeGiftWraps(
                        ...
                        handler = { event ->
                            ...
                            val dmHandler = dmHandlerField.get(geohashViewModel) as com.lemn.app.nostr.NostrDirectMessageHandler
    ...
    fun openLatestUnreadPrivateChat() {
        try {
            ...
            val openPeer: String = if (targetKey.startsWith("nostr_")) {
                ...
                val canonical = com.lemn.app.services.ConversationAliasResolver.resolveCanonicalPeerID(
                    ...
                    nostrPubHexForAlias = { alias -> com.lemn.app.nostr.GeohashAliasRegistry.get(alias) },
                    findNoiseKeyForNostr = { key -> com.lemn.app.favorites.FavoritesPersistenceService.shared.findNoiseKey(key) }
                )
                canonical ?: targetKey
            }
    ...
    fun sendMessage(content: String) {
        ...
        if (content.startsWith("/")) {
            ...
            commandProcessor.processCommand(content, meshService, meshService.myPeerID, { messageContent, mentions, channel ->
                if (selectedLocationForCommand is com.lemn.app.geohash.ChannelID.Location) {
        ...
        if (selectedPeer != null) {
            ...
            selectedPeer = com.lemn.app.services.ConversationAliasResolver.resolveCanonicalPeerID(
            ...
            privateChatManager.sendPrivateMessage(
                ...
                val router = com.lemn.app.services.MessageRouter.getInstance(getApplication(), meshService)
                router.sendPrivate(messageContent, peerID, recipientNicknameParam, messageId)
            }
        } else {
            // Check if we're in a location channel
            val selectedLocationChannel = state.selectedLocationChannel.value
            if (selectedLocationChannel is com.lemn.app.geohash.ChannelID.Location) {
    ...
    fun toggleFavorite(peerID: String) {
        ...
        try {
            ...
            if (noiseKey != null) {
                ...
                val identityManager = com.lemn.app.identity.SecureIdentityStateManager(getApplication())
                ...
                com.lemn.app.favorites.FavoritesPersistenceService.shared.updateFavoriteStatus(
                ...
                try {
                    val myNostr = com.lemn.app.nostr.NostrIdentityBridge.getCurrentNostrIdentity(getApplication())
    ...
    private fun updateReactiveStates() {
        ...
        sessionStates.forEach { (peerID, newState) ->
            ...
            if (old != "established" && newState == "established") {
                com.lemn.app.services.MessageRouter
    ...
    fun panicClearAllData() {
        ...
        try {
            com.lemn.app.services.SeenMessageStore.getInstance(getApplication()).clear()
        } catch (_: Exception) { }
        ...
        com.lemn.app.features.file.FileUtils.clearAllMedia(getApplication())
        ...
        try {
            ...
            try {
                val store = com.lemn.app.geohash.GeohashBookmarksStore.getInstance(getApplication())
                store.clearAll()
            } catch (_: Exception) { }
        ...
        Log.w(TAG, "ðŸš¨ PANIC MODE COMPLETED - New identity: ${meshService.myPeerID}")
    }
    ...
    private fun recreateMeshServiceAfterPanic() {
        ...
        Log.d(
            TAG,
            "âœ… Mesh service recreated. Old peerID: $oldPeerID, New peerID: ${meshService.myPeerID}"
        )
    }
    ...
    fun selectLocationChannel(channel: com.lemn.app.geohash.ChannelID) {
