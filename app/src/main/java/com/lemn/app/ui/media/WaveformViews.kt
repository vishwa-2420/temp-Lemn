...
import com.lemn.app.features.voice.AudioWaveformExtractor
import com.lemn.app.features.voice.VoiceWaveformCache
import com.lemn.app.features.voice.resampleWave
...
fun ScrollingWaveformRecorder(
    ...
    WaveformCanvas(
        ...
        samples = samples,
        fillProgress = 1f,
        baseColor = colorScheme.outline.copy(alpha = 0.35f),
...
fun WaveformPreview(
    ...
    WaveformCanvas(
        ...
        baseColor = colorScheme.secondary.copy(alpha = 0.12f),
        fillColor = when {
            sendProgress != null -> colorScheme.secondary
