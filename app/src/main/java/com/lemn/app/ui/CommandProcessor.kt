...
class CommandProcessor(
    ...
    fun processCommand(command: String, meshService: BluetoothMeshService, myPeerID: String, onSendMessage: (String, List<String>, String?) -> Unit, viewModel: ChatViewModel? = null): Boolean {
        ...
        when (cmd) {
            ...
            "/slap" -> handleActionCommand(parts, "slaps", "around a bit with a large trout ðŸŸ", meshService, myPeerID, onSendMessage)
    ...
    private fun handleActionCommand(
        ...
        if (parts.size > 1) {
            ...
            val isInLocationChannel = state.selectedLocationChannel.value is com.lemn.app.geohash.ChannelID.Location
