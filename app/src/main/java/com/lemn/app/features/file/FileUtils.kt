package com.lemn.app.features.file
...
object FileUtils {
    ...
    fun saveFileFromUri(
        ...
        return try {
            ...
            if (inputStream == null) {
                Log.e(TAG, "âŒ Failed to open input stream for URI: $uri")
                return null
            }
    ...
    fun copyFileForSending(context: Context, uri: Uri, originalName: String? = null): String? {
        ...
        return try {
            ...
            Log.e(TAG, "âŒ CRITICAL: Failed to copy file for sending", e)
            Log.e(TAG, "âŒ Source URI: $uri")
            Log.e(TAG, "âŒ Original name: $originalName")
    ...
    fun saveIncomingFile(
        context: Context,
        file: com.lemn.app.model.BitchatFilePacket
    ): String {
     ...
     */
    fun messageTypeForMime(mime: String): com.lemn.app.model.BitchatMessageType {
        val lower = mime.lowercase()
        return when {
            lower.startsWith("image/") -> com.lemn.app.model.BitchatMessageType.Image
            lower.startsWith("audio/") -> com.lemn.app.model.BitchatMessageType.Audio
            else -> com.lemn.app.model.BitchatMessageType.File
        }
    }
